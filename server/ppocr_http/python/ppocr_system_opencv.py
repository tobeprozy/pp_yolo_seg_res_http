...
def main(opt):
    ...
    for batch_idx in range(0, len(img_file_list), batch_size):
        ...
        for i, result in enumerate(results_list):
            ...
            for j in range(0, len(result["text"])):
                ...
                tmp.append(result_json_per_box)
            ...
            _, encoded_image = cv2.imencode('.jpg', draw_img)
            base64_image = base64.b64encode(encoded_image).decode('utf-8')
            put_element(my_queue, [img_name_splited, tmp, base64_image])
    ...
    save_json = "results/ppocr_system_results_b" + str(opt.batch_size) + "_" + opt.bmodel_type + ".json"
...
def parse_opt():
    ...
    parser.add_argument('--input', type=str, default='datasets/train_full_images_0', help='input image directory path')
    ...
    parser.add_argument('--bmodel_det', type=str, default='models/BM1684/ch_PP-OCRv3_det_fp32.bmodel', help='detector bmodel path')
    parser.add_argument('--det_limit_side_len', type=int, default=[640])
    # params for text recognizer
    parser.add_argument('--bmodel_rec', type=str, default='models/BM1684/ch_PP-OCRv3_rec_fp32.bmodel', help='recognizer bmodel path')
    ...
    parser.add_argument('--bmodel_cls', type=str, default='models/BM1684/ch_PP-OCRv3_cls_fp32.bmodel', help='classifier bmodel path')
    parser.add_argument("--label_list", type=list, default=['0', '180'])
    parser.add_argument("--cls_thresh", type=float, default=0.9)
    parser.add_argument("--bmodel_type", type=str, default='fp32')
    opt = parser.parse_args()
    return opt

def create_task(bmodel):
    print("===============")
    print("PP-OCR-V3-TEST")
    print("===============")
    opt = parse_opt()
    if bmodel=='int8':
        opt.bmodel_det='models/BM1684/ch_PP-OCRv3_det_int8.bmodel'
        opt.bmodel_rec='models/BM1684/ch_PP-OCRv3_rec_int8.bmodel'
        opt.bmodel_type=bmodel
    main(opt)
