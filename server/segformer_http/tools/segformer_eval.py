...
def argsparser():
    ...
    parser.add_argument('--result_json', type=str, default='results/segformer.b0.512x1024.city.160k_fp32_1b.bmodel_cityscapes_opencv_python_result.json', help='path of result json')
